...
def create_argument_parser():
    arg_parser = argparse.ArgumentParser(
        ...
        epilog='Go to http://proxylist.hidemyass.com/ to see the '
    ...
    arg_parser.add_argument('--proxy', type=str, dest='proxy', action='store',
                        required=False, help='''A http proxy with the following format: "(proxy_ip|proxy_host):Port\\n"
                        Example file: 127.0.0.1:8778\n192.168.1.10:8118\n''')
